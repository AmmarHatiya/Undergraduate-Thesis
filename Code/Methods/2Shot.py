# 
# 2-Shot Prompt Engineering Method
# 
...
csv_file = "prompt_w_2example.csv"
...
save_svg_as_png_with_white_background(image_path[:-3]+"svg", image_path)
example_image2 = encode_image(image_path)
...
"""
              ...
              {
                "type": "text",
                "text": """Here are 2 examples for you to follow (Images with questions and answers): """ 
              },
              {
                "type": "text",
                "text": """Image 1: """ + example2_qa
              },
              {
                "type": "image_url",
                "image_url": {
                  "url": f"data:image/jpeg;base64,{example_image2}"
                }
              },
              {
                "type": "text",
                "text": """Image 2: """ + example_qa
              },
              {
                "type": "image_url",
                "image_url": {

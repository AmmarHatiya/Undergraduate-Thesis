# 
# 1-Shot + Categorization (Procedural) Prompt Engineering Method
# 
...
csv_file = "category_procedural_w_example.csv"
            ...
            "content": [
              {
                ...
                The given image is a procedural image, meaning it displays a step-by-step procedure in order to achieve a goal. 
...
image_names = set()
with open("procedural_diagram_Images.csv", mode='r', newline='') as file:

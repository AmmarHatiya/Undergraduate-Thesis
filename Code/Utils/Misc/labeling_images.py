        ...
        "messages": [
          {
            ...
            "content": [
                {
                "type": "text",
                "text": "Label the following image as 1 of the following types: Procedural (shows processes to achieve a goal), Diagram (diagram that shows a portion of the subject, often numbered to illustrate parts), Icon. Please respond with only 1 word, no Punctuation."
              },
              {
                "type": "image_url",
                "image_url": {

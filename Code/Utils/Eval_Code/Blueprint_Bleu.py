# # # 
# # # Compute BLEU scores between each generated question and ground truth questions
# # # 
...
folder_path = 'Evaluation/Bleu/1.0 Base Prompt'
...
result_df.to_csv(os.path.join(folder_path, '1_0_base_Q.csv'), index=False)
...
# Save the dataframe to a CSV file in the specified folder
result_df.to_csv(os.path.join(folder_path, '1_0_base_A.csv'), index=False)
